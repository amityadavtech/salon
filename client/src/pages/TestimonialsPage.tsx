...
const testimonials = [
  {
    ...
    content: "The transformation at Sumeeran Salon & Academy was incredible! The stylists are true artists and the atmosphere is so luxurious. I always leave feeling like a new person. The attention to detail and personalized service is unmatched.",
    rating: 5,
    type: "salon" as const,
