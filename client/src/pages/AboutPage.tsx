...
const milestones = [
  { year: "2009", event: "Sumeeran Salon & Academy Founded", description: "Started with a small salon and big dreams" },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                Founded in 2009, Sumeeran Salon & Academy began as a vision to create a space where beauty meets artistry. 
            ...
            >
              <img
                src={salonImage}
                alt="Sumeeran Salon & Academy Interior"
